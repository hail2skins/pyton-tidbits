...
def insert_data(conn, data):
    ...
    for donor in data:
        ...
        cursor.execute("""
            INSERT INTO donors_donor (last_name, first_name, street_number, street_name, city, state, zip, needs_review) 
        ...
        for contribution in donor['contributions']:
            cursor.execute("""
                INSERT INTO contributions_contribution (donor_id, date, amount) 
                VALUES (%s, %s, %s)
